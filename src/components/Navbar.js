        ...
        <div>
            <nav className="navbar navbar-expand-lg navbar-dark bg-success position-sticky"
                ...
                <div className="container-fluid">
                    <Link className="navbar-brand fs-1 fst-italic" to="/">MyFoodApp</Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        {(!localStorage.getItem("token")) ?
                            ...
                            <div>
                                ...
                                <div className="btn bg-white text-success mx-2 " style={{height:"39px !important"}} onClick={loadCart}>
                                    <Badge  className='bg-danger text-white'  badgeContent={items.length} ><b>{items.length}
                                    </b>
                                    </Badge>
